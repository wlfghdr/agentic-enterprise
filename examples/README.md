...
This folder contains walkthrough examples showing how the agentic enterprise operating model works end-to-end. Each example follows a different path through the 5 layers and 4 loops, exercising different mechanisms of the operating model.

## Available Examples

| Example | Angle | Key Layers Exercised |
|---------|-------|---------------------|
...
1. **Onboarding material** — New team members can trace work through the full lifecycle
