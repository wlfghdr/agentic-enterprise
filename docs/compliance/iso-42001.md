...
| 6.2 | AI objectives, measurable, monitored | Partial (~70%) | AI governance policy principles serve as directional objectives. [AI objectives register template](templates/_TEMPLATE-aims-objectives.md) provides a formal structure for measurable objectives, monitoring, communication, review cadence, and achievement plans. | Template now exists, but adopters still need a completed objectives register with real targets, owners, timelines, and evaluation evidence. |
...
| Control | Title | Coverage | Status | Framework Implementation | Gaps & Quick Wins |
|---------|-------|----------|--------|--------------------------|-------------------|
| A.6.1.2 | Objectives for responsible development | 85% | ✅ Strong | AI governance principles (§0) and fairness/explainability/robustness objectives in ai-governance.md. [AI objectives register template](templates/_TEMPLATE-aims-objectives.md) adds documented objectives with lifecycle-stage integration measures. | Strong template coverage. Adopters still need to instantiate stage-specific objectives and evidence for their actual development lifecycle. |
...
| A.8.3 | External reporting | 80% | ✅ Strong | [AI Governance Policy](../../org/4-quality/policies/ai-governance.md) §6A.1 now defines external adverse-impact reporting channels, intake data, triage ownership, severity escalation, acknowledgement targets, and evidence retention. | Remaining work is deployment-specific: adopters must instantiate the actual mailbox/form/support path and publish it on external surfaces. |
...
| A.8.5 | Information for interested parties | 75% | ⚠️ Partial | [AI Governance Policy](../../org/4-quality/policies/ai-governance.md) §6A.2 defines information categories, routing, disclosure authority, jurisdiction-aware timing, and law-enforcement/regulator escalation for AI-system reporting. | Still needs adopter-specific runbooks and jurisdiction registers that name actual deadlines, authorities, and customer-assurance response windows. |
...
| A.9.3 | Objectives for responsible use | 85% | ✅ Strong | Fairness, explainability, robustness, accountability are addressed as governance requirements. Human oversight via autonomy tiers. [AI objectives register template](templates/_TEMPLATE-aims-objectives.md) pre-populates responsible-use objective areas including accessibility and human oversight. | Strong template coverage. Adopters still need to set deployment-specific responsible-use targets, ownership, and monitoring evidence. |
...
| A.10.4 | Customers | 80% | ✅ Strong | [Customer Policy](../../org/4-quality/policies/customer.md) now includes AI-specific customer requirement capture, domain-of-use and limitation disclosure, shared-responsibility allocation, and change-triggered revalidation of customer expectations. | Remaining work is deployment-specific: adopters must instantiate product-specific disclosures, contract language, and onboarding evidence. |
