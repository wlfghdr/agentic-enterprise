...
**Addressed by framework templates:** AIMS scope statement guidance ([guide](remediation/iso-42001-aims-scope.md)), [AIMS scope statement template](templates/_TEMPLATE-aims-scope.md), and [AI system inventory template](templates/_TEMPLATE-ai-system-inventory.md).
