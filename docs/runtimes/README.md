...
| **Paperclip observability extension semantics** | [`paperclip-observability-extension-semantics.md`](paperclip-observability-extension-semantics.md) | Defines the extension-layer contract that turns Paperclip-backed observability signals into governed Agentic Enterprise work |
