# Agent Type Definition: Product Strategy Agent
...
| Field | Value |
|-------|-------|
| **ID** | `strategy-product-strategy-agent` |
...
Validates strategic alignment of initiatives, analyzes cross-initiative dependencies, and ensures portfolio coherence across all ventures.

**Problem solved:**
Prevents initiative fragmentation. Ensures the product portfolio tells a coherent story.
