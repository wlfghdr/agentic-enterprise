# Agent Type Definition: Sales Strategy Agent
...
| Field | Value |
|-------|-------|
| **ID** | `strategy-sales-strategy-agent` |
...
Analyzes pipeline data, drafts ideal customer profiles, and identifies high-probability deal patterns grounded in historical win/loss data.

**Problem solved:**
Turns CRM data into sales intelligence. Identifies what is working and replicates it systematically.
