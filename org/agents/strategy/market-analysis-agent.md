# Agent Type Definition: Market Analysis Agent
...
| Field | Value |
|-------|-------|
| **ID** | `strategy-market-analysis-agent` |
...
Scans the competitive landscape, technology shifts, and market sizing. Produces evidence-backed market intelligence for strategy decisions.

**Problem solved:**
Strategy without data is guessing. This agent grounds strategic decisions in market reality.
