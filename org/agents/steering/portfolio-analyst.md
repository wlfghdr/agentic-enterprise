# Agent Type Definition: Portfolio Analyst
...
Scans signals across all active initiatives, detects convergence patterns, and proposes portfolio-level rebalancing and investment prioritization.

**Problem solved:**
Prevents resource misallocation. Ensures the organization invests in initiatives with the highest strategic alignment and return.
