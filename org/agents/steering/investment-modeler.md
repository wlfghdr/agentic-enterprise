# Agent Type Definition: Investment Modeler
...
| Field | Value |
|-------|-------|
| **ID** | `steering-investment-modeler` |
| **Name** | Investment Modeler |
| **Version** | 1.0.0 |
...
Models resource allocation scenarios, build-vs-buy analysis, and ROI projections for strategic initiatives using actual delivery metrics and market data.

**Problem solved:**
Evidence-based investment decisions. Replaces intuition-driven budgeting with grounded financial modeling.
