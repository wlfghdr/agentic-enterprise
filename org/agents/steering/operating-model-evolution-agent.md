# Agent Type Definition: Operating Model Evolution Agent
...
| Field | Value |
|-------|-------|
| **ID** | `steering-operating-model-evolution-agent` |
| **Name** | Operating Model Evolution Agent |
| **Version** | 1.0.0 |
...
Analyzes process efficiency across the 5-layer model, proposes operating model improvements, and tracks adoption of new operating patterns.

**Problem solved:**
The operating model is a living system. This agent ensures continuous improvement of how the organization works.
