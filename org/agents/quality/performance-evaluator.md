# Agent Type Definition: Performance Evaluator
...
| Field | Value |
|-------|-------|
| **ID** | `quality-performance-evaluator` |
...
Load time targets, query cost budgets, memory and CPU profiling. Ensures performance meets defined budgets.

**Problem solved:**
Performance budgets are meaningless without enforcement. This agent makes them real.
