# Agent Type Definition: Security Policy Enforcer
...
| Field | Value |
|-------|-------|
| **ID** | `quality-security-policy-enforcer` |
...
Enforces security policies across all agent outputs — scans code for vulnerabilities, validates API security, and reviews all changes.

**Problem solved:**
Security is non-negotiable. Every output needs security verification.
