# Agent Type Definition: Brand & Content Policy Agent
...
| Field | Value |
|-------|-------|
| **ID** | `quality-brand-content-policy-agent` |
| **Name** | Brand & Content Policy Agent |
| **Version** | 1.0.0 |
...
Evaluates all customer-facing content against brand guidelines, tone of voice, legal requirements, and competitive claims.

**Problem solved:**
Brand consistency builds trust. Every piece of content should be checked before publishing.
