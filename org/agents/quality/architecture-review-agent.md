# Agent Type Definition: Architecture Review Agent
...
| Field | Value |
|-------|-------|
| **ID** | `quality-architecture-review-agent` |
...
Reviews architectural decisions against company architecture policies. Evaluates changes for API consistency, pattern compliance, and design adherence.

**Problem solved:**
Architecture rot is slow and expensive. Automated review prevents it at scale.
