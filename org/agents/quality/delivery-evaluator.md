# Agent Type Definition: Delivery Evaluator
...
Feature flag readiness, rollback plans, staging verification, and ring promotion readiness evaluation.

**Problem solved:**
Safe delivery requires gatekeeping at every stage. This agent provides it.
