# Agent Type Definition: Experience Evaluator
...
| Field | Value |
|-------|-------|
| **ID** | `quality-experience-evaluator` |
...
Design system compliance, accessibility (WCAG), responsive layout, and dark mode support validation.

**Problem solved:**
Accessibility and design consistency are both legal requirements and user experience imperatives.
