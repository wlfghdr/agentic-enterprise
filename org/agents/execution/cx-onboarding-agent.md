# Agent Type Definition: CX Onboarding Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-cx-onboarding-agent` |
| **Name** | CX Onboarding Agent |
| **Version** | 1.0.0 |
...
Tracks onboarding milestones, suggests next steps, and identifies blockers in the adoption journey.

**Problem solved:**
Time-to-first-value determines long-term retention. Automated onboarding accelerates it.
