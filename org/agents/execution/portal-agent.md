# Agent Type Definition: Portal Agent
...
Maintains service catalogs and API documentation. Auto-detects new services and ensures documentation completeness.

**Problem solved:**
Internal developer experience depends on discoverable, current service documentation.
