# Agent Type Definition: Marketing Content Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-marketing-content-agent` |
...
Drafts press releases, product blogs, and social media content. Ensures messaging consistency.

**Problem solved:**
Consistent, high-velocity content production is essential for modern marketing.
