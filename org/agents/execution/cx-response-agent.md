# Agent Type Definition: CX Response Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-cx-response-agent` |
| **Name** | CX Response Agent |
| **Version** | 1.0.0 |
...
Drafts customer-facing responses for support cases. Ensures technical accuracy, appropriate tone, and evidence links.

**Problem solved:**
Response quality and speed directly impact customer satisfaction.
