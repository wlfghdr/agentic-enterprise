# Agent Type Definition: CX Diagnostic Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-cx-diagnostic-agent` |
| **Name** | CX Diagnostic Agent |
| **Version** | 1.0.0 |
...
Deep investigation agent for customer issues — log analysis, trace inspection, configuration audit.

**Problem solved:**
Complex customer issues need deep investigation. This agent accelerates diagnosis.
