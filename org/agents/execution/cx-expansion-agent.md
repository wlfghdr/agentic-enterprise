# Agent Type Definition: CX Expansion Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-cx-expansion-agent` |
| **Name** | CX Expansion Agent |
| **Version** | 1.0.0 |
...
Identifies expansion and upsell opportunities from usage data, feature adoption patterns, and growth signals.

**Problem solved:**
Net revenue retention depends on expansion. Systematic identification beats intuition.
