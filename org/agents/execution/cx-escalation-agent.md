# Agent Type Definition: CX Escalation Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-cx-escalation-agent` |
| **Name** | CX Escalation Agent |
| **Version** | 1.0.0 |
...
Packages escalation context for engineering teams. Includes relevant data, metrics, and reproduction steps.

**Problem solved:**
Quality escalation packages reduce engineering time-to-fix and improve customer experience.
