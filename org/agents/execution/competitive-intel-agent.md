# Agent Type Definition: Competitive Intel Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-competitive-intel-agent` |
...
Monitors competitor activity and surfaces alerts. Tracks pricing changes, feature launches, and positioning shifts.

**Problem solved:**
Competitive intelligence must be continuous, not periodic. Automated monitoring achieves this.
...
| **Division DIVISION.md** | `org/3-execution/divisions/product-marketing/DIVISION.md` |
