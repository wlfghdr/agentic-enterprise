# Agent Type Definition: CX Renewal Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-cx-renewal-agent` |
| **Name** | CX Renewal Agent |
| **Version** | 1.0.0 |
...
Prepares renewal packages, assesses churn risk, and generates evidence-backed value realization reports.

**Problem solved:**
Renewals are the revenue engine. Evidence-backed preparation improves outcomes.
