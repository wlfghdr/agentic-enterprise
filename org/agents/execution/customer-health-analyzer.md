# Agent Type Definition: Customer Health Analyzer
...
| Field | Value |
|-------|-------|
| **ID** | `exec-customer-health-analyzer` |
...
Analyzes customer health, usage patterns, and adoption metrics. Generates proactive health reports.

**Problem solved:**
Customer health is the leading indicator of retention. Proactive monitoring prevents churn.
