# Agent Type Definition: Cloud Infrastructure Monitor
...
| Field | Value |
|-------|-------|
| **ID** | `exec-cloud-infrastructure-monitor` |
...
Multi-cloud service monitoring — tracks cloud service health, API latency, and regional availability.

**Problem solved:**
Multi-cloud is reality. Unified monitoring across providers is essential.
