# Agent Type Definition: Security Intelligence Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-security-intelligence-agent` |
...
Security event correlation, threat pattern detection, and threat intelligence integration.

**Problem solved:**
Threat intelligence makes security proactive rather than reactive.
