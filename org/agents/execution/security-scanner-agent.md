# Agent Type Definition: Security Scanner Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-security-scanner-agent` |
...
SAST/DAST scanning and dependency scanning on every pull request. Integrates with CI/CD pipelines.

**Problem solved:**
Shift-left security is an industry best practice. Every PR should be scanned.
