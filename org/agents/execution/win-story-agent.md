# Agent Type Definition: Win Story Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-win-story-agent` |
| **Name** | Win Story Agent |
| **Version** | 1.0.0 |
...
Drafts win stories from deal data (anonymized). Creates evidence-backed success narratives for sales enablement.

**Problem solved:**
Social proof drives deals. Automated win story creation scales the reference pipeline.
