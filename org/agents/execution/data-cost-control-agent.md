# Agent Type Definition: Data Cost Control Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-data-cost-control-agent` |
| **Name** | Data Cost Control Agent |
| **Version** | 1.0.0 |
...
Data cost optimization, storage lifecycle management, and tiered storage policies.

**Problem solved:**
Data volume grows faster than budgets. Active cost management is essential.
