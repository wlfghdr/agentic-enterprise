# Agent Type Definition: Attack Detection Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-attack-detection-agent` |
| **Name** | Attack Detection Agent |
| **Version** | 1.0.0 |
...
Real-time attack identification and automated blocking. Detects SQL injection, XSS, and OWASP Top 10 attacks.

**Problem solved:**
Runtime attack detection is essential for any production system.
