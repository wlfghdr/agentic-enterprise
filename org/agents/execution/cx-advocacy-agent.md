# Agent Type Definition: CX Advocacy Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-cx-advocacy-agent` |
| **Name** | CX Advocacy Agent |
| **Version** | 1.0.0 |
...
Identifies reference candidates and assembles case study data. Tracks satisfaction trends for advocacy programs.

**Problem solved:**
Happy customers are the best marketing. Systematic identification scales advocacy.
