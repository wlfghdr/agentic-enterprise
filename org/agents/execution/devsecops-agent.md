# Agent Type Definition: DevSecOps Agent
...
Security findings as CI/CD signals. Generates SARIF reports and SBOM output for pipeline integration.

**Problem solved:**
Security must be part of the development pipeline, not bolted on after.
