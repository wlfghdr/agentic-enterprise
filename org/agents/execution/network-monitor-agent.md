# Agent Type Definition: Network Monitor Agent
...
Network flow analysis, latency monitoring, and connectivity health. Detects partitions and routing anomalies.

**Problem solved:**
Networking issues are the hardest to diagnose. Automated monitoring is essential.
