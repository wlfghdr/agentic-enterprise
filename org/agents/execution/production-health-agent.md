# Agent Type Definition: Production Health Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-production-health-agent` |
| **Name** | Production Health Agent |
| **Version** | 1.0.0 |
...
Monitors service health, detects anomalies, tracks key operational metrics, and surfaces degradation before users are impacted.

**Problem solved:**
Proactive health monitoring is foundational for any production system. Catches problems before they become incidents.
