# Agent Type Definition: Schema Management Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-schema-management-agent` |
...
Manages data schemas, ensures backward compatibility, and orchestrates schema migrations.

**Problem solved:**
Schema evolution is one of the most error-prone operations. Automation prevents data corruption.
