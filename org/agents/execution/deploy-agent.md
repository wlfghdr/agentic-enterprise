# Agent Type Definition: Deploy Agent
...
Executes staging and production deployments with automated verification. Manages deployment strategies (blue-green, canary, rolling).

**Problem solved:**
Deployment is where code becomes product. Safe, automated deployment is foundational.
