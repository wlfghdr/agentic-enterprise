# Agent Type Definition: Training Agent
...
Generates training content and certification modules. Creates interactive labs and assessments.

**Problem solved:**
Product adoption depends on enablement. Automated training creation scales with the product.
