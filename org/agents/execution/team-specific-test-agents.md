# Agent Type Definition: Team-Specific Test Agents
...
| Field | Value |
|-------|-------|
| **ID** | `exec-team-specific-test-agents` |
| **Name** | Team-Specific Test Agents |
| **Version** | 1.0.0 |
...
Dedicated test agents per team that validate code changes with domain-appropriate testing strategies.

**Problem solved:**
Testing is the verification loop. Every team needs automated test generation and validation.
