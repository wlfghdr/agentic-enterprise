# Agent Type Definition: Coding Agent Fleet
...
| Field | Value |
|-------|-------|
| **ID** | `exec-coding-agent-fleet` |
| **Name** | Coding Agent Fleet |
| **Version** | 1.0.0 |
...
Agent fleet that implements features from decomposed work items. Writes code, tests, and docs in parallel across team boundaries.

**Problem solved:**
The core of AI-assisted software development. Every engineering org benefits from AI coding assistance at scale.
