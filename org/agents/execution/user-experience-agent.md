# Agent Type Definition: User Experience Agent
...
Analyzes real user behavior — Core Web Vitals, conversion funnels, user journeys — and identifies friction points.

**Problem solved:**
User experience is the ultimate business metric. Continuous analysis drives product improvement.
