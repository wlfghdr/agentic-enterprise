# Agent Type Definition: Release Health Agent
...
Tracks deployment health across environments, performs canary analysis, and correlates releases with production impact.

**Problem solved:**
Connects release events to operational impact. Essential for safe, progressive delivery.
