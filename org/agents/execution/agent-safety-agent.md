# Agent Type Definition: Agent Safety Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-agent-safety-agent` |
| **Name** | Agent Safety Agent |
| **Version** | 1.0.0 |
...
Prompt injection prevention, hallucination detection, and agent output safety validation.

**Problem solved:**
As AI agents operate autonomously, ensuring their outputs are safe is critical.
