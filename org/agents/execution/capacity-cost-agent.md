# Agent Type Definition: Capacity & Cost Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-capacity-cost-agent` |
| **Name** | Capacity & Cost Agent |
| **Version** | 1.0.0 |
...
Demand forecasting, right-sizing, cost trending, and FinOps optimization. Ensures resource allocation matches demand efficiently.

**Problem solved:**
Over-provisioning wastes money; under-provisioning causes outages. Balancing both is universally valuable.
