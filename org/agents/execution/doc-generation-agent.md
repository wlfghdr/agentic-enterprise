# Agent Type Definition: Doc Generation Agent
...
Creates documentation from code, APIs, and specs. Auto-detects documentation gaps.

**Problem solved:**
Documentation is always behind. This agent keeps it current automatically.
