# Agent Type Definition: IAM Agent
...
Identity, authentication, and authorization management across the infrastructure.

**Problem solved:**
Security starts with identity. Automated IAM management reduces risk and toil.
