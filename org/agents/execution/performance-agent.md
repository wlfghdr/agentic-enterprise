# Agent Type Definition: Performance Agent
...
Baseline comparisons, regression detection, and performance profiling. Identifies optimization opportunities across the stack.

**Problem solved:**
Performance regression is silent until users complain. This agent catches it at the source.
