# Agent Type Definition: Infrastructure Provisioning Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-infrastructure-provisioning-agent` |
...
Infrastructure-as-Code and container orchestration management. Provisions and manages infrastructure with policy compliance.

**Problem solved:**
Every cloud-native org provisions infrastructure. Automating it with guardrails is foundational.
