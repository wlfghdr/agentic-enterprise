# Agent Type Definition: Demo Environment Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-demo-environment-agent` |
...
Maintains and customizes demo environments per release. Ensures demo scenarios work with latest features.

**Problem solved:**
Bad demos lose deals. Automated demo environment management ensures reliability.
