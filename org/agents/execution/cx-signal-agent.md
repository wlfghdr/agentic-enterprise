# Agent Type Definition: CX Signal Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-cx-signal-agent` |
| **Name** | CX Signal Agent |
| **Version** | 1.0.0 |
...
Identifies customer patterns across support interactions and generates product improvement signals.

**Problem solved:**
Closes the loop between support experience and product improvement.
