# Agent Type Definition: Auto-Remediation Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-auto-remediation-agent` |
...
Automated remediation with evidence trails and rollback capabilities. Executes proven remediation playbooks within policy boundaries.

**Problem solved:**
Known problems should never require human intervention. This agent codifies and executes fixes.
