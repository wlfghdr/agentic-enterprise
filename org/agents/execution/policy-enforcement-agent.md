# Agent Type Definition: Policy Enforcement Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-policy-enforcement-agent` |
...
RBAC policy enforcement and governance. Ensures access control compliance across the infrastructure.

**Problem solved:**
Policy without enforcement is wishful thinking. Automation makes compliance real.
...
| **Division DIVISION.md** | `org/3-execution/divisions/core-services/DIVISION.md` |
