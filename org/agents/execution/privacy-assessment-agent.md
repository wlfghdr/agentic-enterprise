# Agent Type Definition: Privacy Assessment Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-privacy-assessment-agent` |
...
GDPR/CCPA privacy impact assessments. Scans code and data flows for PII handling and compliance issues.

**Problem solved:**
Privacy regulation applies to almost every enterprise. Automated assessment scales.
