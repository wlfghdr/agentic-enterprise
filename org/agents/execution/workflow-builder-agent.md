# Agent Type Definition: Workflow Builder Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-workflow-builder-agent` |
...
Creates and maintains automation workflow definitions. Translates natural language intents into executable workflows.

**Problem solved:**
Every organization automates processes. This agent accelerates and maintains that automation.
...
| **Division DIVISION.md** | `org/3-execution/divisions/ai-intelligence/DIVISION.md` |
