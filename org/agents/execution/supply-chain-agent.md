# Agent Type Definition: Supply Chain Agent
...
SBOM management, dependency auditing, and third-party risk assessment.

**Problem solved:**
Software supply chain attacks are rising. Automated SBOM management is now expected.
