# Agent Type Definition: Incident Response Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-incident-response-agent` |
...
Incident detection, severity classification, response coordination, and communication management across teams.

**Problem solved:**
Structured incident response is essential. This agent accelerates triage, diagnosis, and resolution.
