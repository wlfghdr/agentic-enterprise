# Agent Type Definition: Process Monitor Agent
...
Process-level resource consumption, technology detection, and process group health.

**Problem solved:**
Provides the lowest-level granularity for understanding what is running and consuming resources.
