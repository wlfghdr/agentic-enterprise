# Agent Type Definition: Analyst Prep Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-analyst-prep-agent` |
| **Name** | Analyst Prep Agent |
| **Version** | 1.0.0 |
...
Prepares analyst briefing materials. Creates competitive wave analysis and response packages.

**Problem solved:**
Analyst relations require meticulous, evidence-backed preparation.
