# Agent Type Definition: Compliance Evidence Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-compliance-evidence-agent` |
...
Auto-generates SOC2, ISO 27001, and FedRAMP evidence from CI/CD pipelines and infrastructure configuration.

**Problem solved:**
Audit preparation is expensive and time-consuming. Automation reduces it from weeks to days.
