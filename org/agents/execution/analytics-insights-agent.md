# Agent Type Definition: Analytics & Insights Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-analytics-insights-agent` |
...
Connects business KPIs to technical signals, builds executive dashboards, analyzes process flows, and generates forecasts.

**Problem solved:**
Bridges the business-technology gap. Makes operational data meaningful to every organizational layer.
...
| **Division DIVISION.md** | `org/3-execution/divisions/core-applications/DIVISION.md` |
