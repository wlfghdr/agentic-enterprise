# Agent Type Definition: Trust Scoring Agent
...
Calculates agent trust scores based on evidence quality, verification pass rates, and historical accuracy.

**Problem solved:**
Trust is the foundation of AI agent autonomy. Without scoring, you cannot grant or revoke it.
