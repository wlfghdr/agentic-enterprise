# Agent Type Definition: Host Monitor Agent
...
| Field | Value |
|-------|-------|
| **ID** | `exec-host-monitor-agent` |
| **Name** | Host Monitor Agent |
| **Version** | 1.0.0 |
...
CPU, memory, disk, and network performance monitoring across all host infrastructure.

**Problem solved:**
The foundation layer. You cannot monitor what you cannot see.
