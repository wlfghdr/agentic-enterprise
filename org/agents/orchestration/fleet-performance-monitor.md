# Agent Type Definition: Fleet Performance Monitor
...
| Field | Value |
|-------|-------|
| **ID** | `orch-fleet-performance-monitor` |
| **Name** | Fleet Performance Monitor |
| **Version** | 1.0.0 |
...
Tracks fleet throughput, quality scores, resource consumption, and bottleneck detection across all agent categories.

**Problem solved:**
You cannot improve what you do not measure. This agent provides operational visibility into the entire agent fleet.
