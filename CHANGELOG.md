...
- **Version drift** — README version badge and `CONFIG.yaml → framework_version` still said 4.1.0 while the changelog had already released 4.3.0; both now read 4.3.0.
...
- `docs/compliance/README.md`, `docs/compliance/guides/README.md`, and `docs/compliance/iso-42001.md` — added references to the new AI objectives register template and updated the ISO 42001 coverage narrative for clause 6.2, A.6.1.2, and A.9.3.
...
- New ISO 42001 certification guidance: `docs/compliance/remediation/iso-42001-conformity-assessment.md` — third-party certification body selection guidance, Stage 1 and Stage 2 readiness checklists, framework-vs-adopter evidence mapping, surveillance-audit preparation, and practical timeline guidance for ISO/IEC 42001 certification. Closes #127.
